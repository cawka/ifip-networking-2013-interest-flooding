...
{\color{red} I gave up the idea of seperate discussion section as after trying for some time, I realized there is no way to write a reasonably comprehensive and acceptably broad discussion section that touches on algorithms, evaluation and methodology, etc. So, I decided to get rid of it and only have a scoped down version here that confesses upon the limiations of our evaluations. Whoever has time, please go ahead and write 1-2 paragraphs as outlined below}
